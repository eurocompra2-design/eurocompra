...
if marker not in s:
    patch = """<style id="eurocompra-acesso-codigo-only-style">
...
function init(){
 ...
 const p=sec.querySelector('.form-header p'); if(p) p.textContent='Digite somente o código do cliente para acessar seu cadastro e acompanhar seus pedidos.';
...
print('Patch de acesso somente por codigo aplicado.')
